...
class ViWriteResponse(_message.Message):
  ...
  def __init__(
      self,
      job_id: _Optional[bytes] = ...,
      status_code: _Optional[_Union[AQVI_STATUS, str]] = ...,
  ) -> None: ...
...
class ViGetCommandResultResponse(_message.Message):
  ...
  status_code: AQVI_STATUS
  def __init__(
      self, status_code: _Optional[_Union[AQVI_STATUS, str]] = ...
  ) -> None: ...
...
class ViReadRequest(_message.Message):
  ...
  count: int
  def __init__(
      self, job_id: _Optional[bytes] = ..., count: _Optional[int] = ...
  ) -> None: ...
...
class ViReadResponse(_message.Message):
  ...
  def __init__(
      self,
      status_code: _Optional[_Union[AQVI_STATUS, str]] = ...,
      command_response: _Optional[bytes] = ...,
      ret_count: _Optional[int] = ...,
  ) -> None: ...
