...
# source: pyhal/proto/cominterface/aqvisa.proto
...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(
    b'\n%pyhal/proto/cominterface/aqvisa.proto\x12\x06\x61qvisa"!\n\x0eViWriteRequest\x12\x0f\n\x07\x63ommand\x18\x01'
    b' \x01(\x0c"[\n\x0fViWriteResponse\x12\x13\n\x06job_id\x18\x01'
    b' \x01(\x0cH\x00\x88\x01\x01\x12(\n\x0bstatus_code\x18\x02'
    b' \x01(\x0e\x32\x13.aqvisa.AQVI_STATUSB\t\n\x07_job_id"/\n\x19ViGetCommandResultRequest\x12\x0e\n\x06job_id\x18\x01'
    b' \x01(\x0c:\x02\x18\x01"J\n\x1aViGetCommandResultResponse\x12(\n\x0bstatus_code\x18\x01'
    b' \x01(\x0e\x32\x13.aqvisa.AQVI_STATUS:\x02\x18\x01"2\n\rViReadRequest\x12\x12\n\x06job_id\x18\x01'
    b' \x01(\x0c\x42\x02\x18\x01\x12\r\n\x05\x63ount\x18\x02'
    b' \x01(\x03"\x94\x01\n\x0eViReadResponse\x12(\n\x0bstatus_code\x18\x01'
    b' \x01(\x0e\x32\x13.aqvisa.AQVI_STATUS\x12\x1d\n\x10\x63ommand_response\x18\x02'
    b' \x01(\x0cH\x00\x88\x01\x01\x12\x16\n\tret_count\x18\x03'
    b' \x01(\x03H\x01\x88\x01\x01\x42\x13\n\x11_command_responseB\x0c\n\n_ret_count*\xae\t\n\x0b\x41QVI_STATUS\x12\x11\n\rAQVI_NO_ERROR\x10\x00\x12'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _VIGETCOMMANDRESULTREQUEST._options = None
  _VIGETCOMMANDRESULTREQUEST._serialized_options = b'\030\001'
  _VIGETCOMMANDRESULTRESPONSE._options = None
  _VIGETCOMMANDRESULTRESPONSE._serialized_options = b'\030\001'
  _VIREADREQUEST.fields_by_name['job_id']._options = None
  _VIREADREQUEST.fields_by_name['job_id']._serialized_options = b'\030\001'
  _AQVISA.methods_by_name['ViGetCommandResult']._options = None
  _AQVISA.methods_by_name['ViGetCommandResult']._serialized_options = (
      b'\210\002\001'
  )
  _globals['_AQVI_STATUS']._serialized_start = 506
  _globals['_AQVI_STATUS']._serialized_end = 1704
  _globals['_VIWRITEREQUEST']._serialized_start = 49
  _globals['_VIWRITEREQUEST']._serialized_end = 82
  _globals['_VIWRITERESPONSE']._serialized_start = 84
  _globals['_VIWRITERESPONSE']._serialized_end = 175
  _globals['_VIGETCOMMANDRESULTREQUEST']._serialized_start = 177
  _globals['_VIGETCOMMANDRESULTREQUEST']._serialized_end = 224
  _globals['_VIGETCOMMANDRESULTRESPONSE']._serialized_start = 226
  _globals['_VIGETCOMMANDRESULTRESPONSE']._serialized_end = 300
  _globals['_VIREADREQUEST']._serialized_start = 302
  _globals['_VIREADREQUEST']._serialized_end = 352
  _globals['_VIREADRESPONSE']._serialized_start = 355
  _globals['_VIREADRESPONSE']._serialized_end = 503
  _globals['_AQVISA']._serialized_start = 1707
  _globals['_AQVISA']._serialized_end = 1934
